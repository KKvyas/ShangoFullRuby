...
describe RoutesController do
  ...
  let(:valid_attributes) { { "feature_id" => "1", "name" => "name" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved route as @route" do
        ...
        allow_any_instance_of(Route).to receive(:save).and_return(false)
        post :create, {:route => { "feature_id" => "invalid value" }}, valid_session
        expect(assigns(:route)).to be_a_new(Route)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested route" do
        ...
        expect_any_instance_of(Route).to receive(:update).with({ "feature_id" => "1" })
        put :update, {:id => route.to_param, :route => { "feature_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the route as @route" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Route).to receive(:save).and_return(false)
        put :update, {:id => route.to_param, :route => { "feature_id" => "invalid value" }}, valid_session
        expect(assigns(:route)).to eq(route)
      end
