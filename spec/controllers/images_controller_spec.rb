  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved image as @image" do
        ...
        post :create, {:image => { "activity_id" => "invalid value" }}, valid_session
        expect(assigns(:image)).to be_a_new(Image)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested image" do
        ...
        expect_any_instance_of(Image).to receive(:update).with({ "activity_id" => "1" })
        put :update, {:id => image.to_param, :image => { "activity_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the image as @image" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Image).to receive(:save).and_return(false)
        put :update, {:id => image.to_param, :image => { "activity_id" => "invalid value" }}, valid_session
        expect(assigns(:image)).to eq(image)
      end
